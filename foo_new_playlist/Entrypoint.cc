...
static GUID const g_pattern_guid = { 0xd753f438, 0x37c6, 0x406b, { 0xa5, 0x2a, 0xa, 0x71, 0x61, 0xaf, 0x6e, 0x3a } };

static advconfig_string_factory g_pattern_value("New playlist pattern",
                                                g_pattern_guid,
...
struct Commands : mainmenu_commands
{
    ...
    GUID get_command(t_uint32 p_index) override
    {
        ...
        static GUID const s_guid = { 0x8af7e67f, 0xf298, 0x4f76, { 0xb8, 0x99, 0x5d, 0x35, 0x31, 0x56, 0x4, 0x3d } };
        return s_guid;
    }

    void get_name(t_uint32 p_index, pfc::string_base& p_out) override { p_out = "New named playlist"; }
